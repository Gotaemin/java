...
INSERT INTO `movielist` VALUES (1,'백두산',20000,'하정우','백두산'),(2,'천문',150000,'한석규','천문'),(3,'닥터 두리틀',300000,'로다주','닥터 두리틀'),(4,'히트맨',150000,'권상우','히트맨');
...
-- Dump completed on 2020-03-16  0:38:30
